...
func InRange[T any, V got.CompareProvider[T]](min, max T) func(V) bool {
...
func GreaterThan[T any, V got.CompareProvider[T]](v T) func(V) bool {
...
func LessThan[T any, V got.CompareProvider[T]](v T) func(V) bool {
	return func(x V) bool {
		return x.Compare(v) < 0
	}
}
...
func GreaterOrEqualTo[T any, V got.CompareProvider[T]](v T) func(V) bool {
	return func(x V) bool {
		return x.Compare(v) >= 0
	}
}
...
func LessOrEqualTo[T any, V got.CompareProvider[T]](v T) func(V) bool {
	return func(x V) bool {
		return x.Compare(v) <= 0
	}
}
...
func EqualTo[T any, V got.CompareProvider[T]](v T) func(V) bool {
	return func(x V) bool {
		return x.Compare(v) == 0
	}
}
...
func Equal[T any, V got.CompareProvider[T]](a V, b T) bool {
	return a.Compare(b) == 0
}

// IsZero returns result of zero testing.
func IsZero[T got.ZeroTestProvider](v T) bool {
	return v.IsZero()
}
